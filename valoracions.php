<?php
include './conexion.php'; // Arxiu de connexió 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Enviar'])) {
    if (
        ...
        if ($resultado) {
            $mensajes = "<br>Enviat<br>";
        } else {
            $mensajes = "<br>Ha ocorregut un error: " . mysqli_error($conex) . "<br>";
        }
    } else {
        $mensajes = "<br>Omple tots els camps<br>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div id="formulario" class="container">
            ...
            <form method="POST" action="">
                ...
                <div class="inputbox">
                    ...
                    <select name="Estrellas" id="estrellas" required>
                        <option disabled selected value="">Seleccioneu...</option>
        ...
        <h2>Valoracions</h2>
        <input type="text" id="filter-input" onkeyup="filterTable()" placeholder="Cercar per usuari...">
            ...
            <tbody>
                ...
                if ($conex !== null) {
                    ...
                    if ($result !== false && $result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='3'>0 resultats</td></tr>";
                    }
                    $conex->close();
                } else {
                    echo "<tr><td colspan='3' class='error'>Error: La connexió a la base de dades és nul·la.</td></tr>";
                }
                ?>
            </tbody>
        </table>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer__social">
                <a href="https://www.etpxavier.com/ca/" target="_blank" style="color: black;" class="footer__social-link">Pàgina ETPXavier</a>
